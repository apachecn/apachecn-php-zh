...
![How it works...](img/B05314_11_01.jpg)
...
![How it works...](img/B05314_11_02.jpg)
...
![How it works...](img/B05314_11_03.jpg)
...
![How it works...](img/B05314_11_04.jpg)
...
![How it works...](img/B05314_11_05.jpg)
...
![How it works...](img/B05314_11_06.jpg)

然后我们可以使用 SQL`JOIN`直接从数据库中查看数据，以确保关系得到维护：

![How it works...](img/B05314_11_07.jpg)
...
5.  Next, we need to implement a way to embed related objects. We will start with the `Application\Entity\Customer` parent class. For this section, we will assume the following relationships, illustrated in the following diagram:
    ...
    *   一次购买，一种产品
    ...
    ![Technique #1 - pre-loading all child information](img/B05314_11_08.jpg)
...
![How it works...](img/B05314_11_09.jpg)
...
![How it works...](img/B05314_11_10.jpg)
