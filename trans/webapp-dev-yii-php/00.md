...
[第三章](03.html "Chapter 3. The TrackStar Application")*TrackStar应用*介绍TrackStar应用。这是一个在线、项目管理和问题跟踪应用程序，您将在其余章节中构建该应用程序。在这里，您将学习如何将 Yii 应用程序连接到基础数据库。您还将学习如何从命令行运行交互式 shell。本章的最后一部分重点介绍了 Yii 应用程序中的单元测试和功能测试，并提供了一个用 Yii 编写单元测试的具体示例。
