...
1.  导航至`http://localhost/trackstar/index.php?r=gii`处的 Gii 发生器菜单，并选择**CURD发生器**链接。
...
现在，我们有了一个与项目相关的问题列表，并将其显示在项目详细信息页面上。我们还可以查看问题的详细信息（即阅读），以及更新和删除问题的链接。因此，我们的基本CURD操作已经到位。
