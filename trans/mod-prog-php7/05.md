...
![Installing Symfony](graphics/B05460_05_01.jpg)
...
![Creating a blank project](graphics/B05460_05_02.jpg)
...
![Creating a blank project](graphics/B05460_05_03.jpg)
...
![Creating a blank project](graphics/B05460_05_04.jpg)

另一方面，`src`目录包含已经模块化的代码，以基本`AppBundle`模块的形式出现，如下面的屏幕截图所示：

![Creating a blank project](graphics/B05460_05_05.jpg)
...
![Using Symfony console](graphics/B05460_05_12.jpg)
...
![Using Symfony console](graphics/B05460_05_11.jpg)
...
![Using Symfony console](graphics/B05460_05_13.jpg)
...
![Using Symfony console](graphics/B05460_05_09.jpg)

在这里，我们可以更改属性值并单击**编辑**将其保留回数据库，或者单击**删除**按钮从数据库中删除实体。

如果我们要使用已存在的电子邮件（标记为唯一字段）创建一个新实体，系统将抛出如下一般错误：

![Using Symfony console](graphics/B05460_05_10.jpg)
...
![The bundle system](graphics/B05460_05_16.jpg)

一旦流程完成，将创建一个包含多个目录和文件的新捆绑包，如以下屏幕截图所示：

![The bundle system](graphics/B05460_05_17.jpg)
...
![Testing](graphics/B05460_05_18.jpg)
