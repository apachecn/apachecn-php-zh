...
![](assets/2e6cd07e-5278-44a0-bf41-28da819dc572.png)
...
![](assets/fd7135e9-4256-4fe9-9950-72f5b86a3c0e.png)
...
![](assets/8627f3dc-2c79-4815-babe-131e0476128d.png)

现在剩下的就是创建一个`index.php`文件，其中包括由 Composer 生成的`autoload.php`文件，我们已经准备好开始使用它了

![](assets/ccd5737a-95a9-4f41-be15-b8026849479e.png)
...
![](assets/adcac991-4be4-46cb-a8f4-d86272baeac5.png)

但是，如果我们删除*错误的*`$user`变量前面的注释，输出结果会稍微出乎意料，或者至少不是我们希望如何处理它：

![](assets/de247ab0-2353-4b00-bf0e-705febf72d38.png)
...
![](assets/540a7acd-603e-456b-bd8b-8d5eb4af2f0c.png)
...
![](assets/24b412d5-df8a-41c2-ae3f-f34d9cb535ad.png)
...
![](assets/dec130cd-c357-416b-a618-5395b5c1c72d.png)
...
![](assets/4c4e8bb4-7afb-408d-b467-b8ea55b2acc4.png)
...
![](assets/4a9d00b2-7ccb-4731-b79f-7ed3a6eb0252.png)

如果我们现在删除`stream_set_blocking($pipes[1], 0);`前面的注释，结果输出将变为：

![](assets/502a795f-e386-41f8-b9d8-4862cd4f2a27.png)
...
![](assets/f69decec-31c7-445e-920e-3c45c3e22e7f.png)
...
![](assets/58f88a2d-ef96-4ca2-b052-662c17135a41.png)
...
![](assets/0c81eb9e-fdaf-4494-98d2-08934a6ff4a9.png)
...
![](assets/48487a6d-646b-4b0a-ac55-4e0520019a7c.png)
...
![](assets/bee357c9-0bb1-42c3-b5bd-146eb5cb191b.png)
...
![](assets/39aa8f7d-4f9a-4c4c-920f-9f8a202dc1c9.png)
