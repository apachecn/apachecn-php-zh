...
![](assets/eccf9606-0241-4f9e-96a6-fa9ecf9b0c0b.png)
...
![](assets/1318241c-5e05-4111-8605-f67714a168e9.png)

在“名称和位置”屏幕上填写所需数据后，单击“下一步”将进入运行配置设置：

![](assets/a010be45-cd7b-4363-a916-6f52df2e9012.png)

点击 Finish 按钮完成项目设置，我们现在应该可以看到我们的`index.php`文件：

![](assets/b69cb494-43c0-499d-8ac6-50deeec4fac3.png)
...
![](assets/5339ee3b-1125-4ec1-a9bb-70729f9f2292.png)
...
![](assets/15d84c26-6ffa-4369-b0fa-e3f34da53eb9.png)
...
![](assets/40e9359f-ad68-4977-ab11-9afc62b6b9ca.png)

代码就位后，访问浏览器中的`http://test.loc`URL 应该会给我们以下输出：

![](assets/b552103b-6a82-4c6a-ad9e-27937067e63d.png)
...
![](assets/f6e9ff1c-9648-470b-b97b-8d189644520f.png)

工具栏本身由几个关键部分组成，每个部分收集一个特定指标：

*   页面请求：

![](assets/f27eaf69-5749-4417-aa62-e75fd5f21d6a.png)

*   执行时间和内存峰值：

![](assets/5041377a-e48e-40a2-aba0-864b7fed093b.png)

*   监视事件：

![](assets/35ccd405-460d-4449-a77b-e0e2c18d4871.png)

*   错误和警告：

![](assets/011e3e78-50ba-4371-a845-dea83ae746c8.png)

*   数据库查询：

![](assets/ce9b1877-5521-4db0-b2cb-104b621cdeca.png)

虽然我们的特定示例应用程序没有数据库交互，但以下输出说明了 Z-Ray 从资源密集型 Magento 电子商务平台捕获原始 SQL 数据库查询及其执行时间：

![](assets/743fd037-ddcc-4e22-b9c3-2db841b2c586.png)

*   功能：

![](assets/d5e769dd-68b4-4199-8c15-a27702ae6155.png)

*   请求信息：

![](assets/78345d2f-bf13-4fec-aee0-2277fbd45748.png)
