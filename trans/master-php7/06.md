...
在本章中，我们了解了 PHP OOP 的一些最基本但鲜为人知的功能，这些功能有时在我们的日常开发中没有得到足够的重视。如今，大多数主流工作都集中在使用框架和平台上，它们往往会从我们这里抽象出其中的一些概念。理解对象的内部工作对成功开发和调试更大的系统至关重要。反射 API 在处理对象时提供了强大的功能。结合我们在[第 4 章](04.html)、*魔法背后的魔法*中提到的魔法方法的力量，PHP OOP 模型似乎功能非常丰富。
