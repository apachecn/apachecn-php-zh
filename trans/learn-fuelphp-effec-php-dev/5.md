...
虽然我们在[第 4 章](4.html "Chapter 4. Demo Application")、*演示应用程序*中提到了Auth 包，但让我们详细检查一下该包。
...
有关配置SimpleAuth 的更多信息以及使用示例，请访问以下链接：
...
Composer允许您声明要在项目中安装哪些版本的库，它将为您安装这些库。这在开发和测试时非常有用，因为您确切地知道安装了什么代码。它还允许您对这些库的任何更改进行源代码控制。
