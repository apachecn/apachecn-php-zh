...
1.  For Windows operating systems, you just need to click through the wizard installation program, as shown in the following screenshot:
    ...
    ![Installing Elasticsearch and the PHP client](graphics/image_04_001.jpg)
...
2.  Once Postman is installed, you can register or skip registration:
    ...
    ![Installing Elasticsearch and the PHP client](graphics/image_04_002.jpg)

3.  Now try doing a `GET request` to `http://localhost:9200`:

    ![Installing Elasticsearch and the PHP client](graphics/image_04_003.jpg)
...
![Building a PHP Elasticsearch tool](graphics/image_04_004.jpg)
...
![Adding documents to our Elasticsearch](graphics/image_04_005.jpg)
...
![Storing Apache logs in Elasticsearch](graphics/image_04_006.jpg)
...
![Dashboard app for viewing Elasticsearch logs](graphics/image_04_007.jpg)
...
![Dashboard app for viewing Elasticsearch logs](graphics/image_04_008.jpg)
...
![Storing and searching XML documents using PHP](graphics/image_04_009.jpg)
