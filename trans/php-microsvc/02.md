...
![Design and architecture to build the basic platform for microservices](graphics/B06142_02_01.jpg)
...
1.  Double-click on the downloaded image (called `Docker.dmg`) to open the installer. Once the image is mounted, you need to drag and drop the Docker app into the `Applications` folder:
    ...
    ![Docker for Mac installation process](graphics/B06142_02_02.jpg)
...
3.  Click on the toolbar whale for **Preferences...** and other options:
    ...
    ![Docker for Mac installation process](graphics/B06142_02_03.jpg)
...
![Installing the Docker tools](graphics/B06142_02_04.jpg)
...
![Installing the Docker tools](graphics/B06142_02_05.jpg)
...
*   `Source`: This folder will have the source of each of our microservices
    ...
    ![Setting up a development environment for microservices](graphics/B06142_02_08.jpg)
...
![Middleware](graphics/B06142_02_09.jpg)
